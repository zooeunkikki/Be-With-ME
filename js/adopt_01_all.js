...
// localstorage가 처음 들어올때는 1로 그 다음부터는 내가 누르는 값으로 대입
...
function snsBtn() {
    let shareBtn = document.querySelector('.share-btn a:nth-of-type(4)');
...
function kakao() {
    let shareBtn3 = document.querySelector('.share-btn a:nth-of-type(3)');
    shareBtn3.addEventListener('click',function(){
    // SDK를 초기화 합니다. 사용할 앱의 JavaScript 키를 설정해 주세요.
    Kakao.init('c3369d14a4ac731e8471a00fe5bf1042');
